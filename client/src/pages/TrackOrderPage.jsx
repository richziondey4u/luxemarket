...
export default function TrackOrderPage() {
  ...
  const handleSearch = async (e) => {
    ...
    // Remove # if the user enters it
    const trackingNumber = query.trim().replace(/^#/, "");

    try {
      const res = await apiClient.trackOrder(trackingNumber);
        ...
        >
          ...
          <div
            style={{
              ...
              zIndex: 1,
              width:
                Math.min((currentStep / (STEPS.length - 1)) * 80, 80) + "%",
    ...
    <div style={{ backgroundColor: "var(--bg-page)", minHeight: "100vh" }}>
      ...
      >
        <div style={{ textAlign: "center", marginBottom: "36px" }}>
          ...
          >
            <Package
              style={{ width: "26px", height: "26px", color: "var(--brand)" }}
            />
          </div>
          <h1
            style={{
        ...
        >
          ...
          <button
            ...
            style={{ borderRadius: "8px", padding: "10px 20px", flexShrink: 0 }}
          >
              ...
              {userOrders.slice(0, 5).map((order) => {
                ...
                return (
                  <button
                    key={order.id}
                    onClick={() => {
                      setQuery(order.orderNumber || order.id);
                      handleSearch({
                        preventDefault: () => {},
                      });
                    }}
