    ...
    <>
      <header style={{ position: "sticky", top: 0, zIndex: 100 }}>
        ...
        <div style={{ backgroundColor: "var(--brand)" }}>
          <div
            style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 12px" }}
          >
            <div
              style={{
                display: "flex",
                    ...
                    {userOpen && (
                      <div
                        style={{
                          ...
                          borderRadius: "8px",
                          boxShadow:
                            "var(--shadow-card, 0 4px 20px rgba(0,0,0,0.15))",
                          overflow: "hidden",
                        }}
                      >
                        <div
      ...
      >
        ...
        {/* Mobile search */}
        <form
          onSubmit={(e) => handleSearch(e, mobileSearch)}
          style={{
            padding: "12px 16px",
            borderBottom: "1px solid var(--border-light)",
            flexShrink: 0,
