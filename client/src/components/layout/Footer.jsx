      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 16px" }}>
        ...
        >
          ...
          <div style={{ gridColumn: "span 1" }}>
            ...
            >
              Nigeria's most trusted online marketplace. Premium products,
              guaranteed quality, delivered fast to your door.
            </p>
            ...
            >
              {[
                {
                  Icon: MapPin,
                  text: "001 Richzion Drive, Victoria Island, Lagos",
                },
                {
                  Icon: Phone,
                  text: "+234 803 983 0412",
                  href: "tel:+2348039830412",
                },
                {
                  Icon: Mail,
                  text: "richzion@luxemarket.com",
                  href: "mailto:richzion@luxemarket.com",
                },
        ...
        >
          <p style={{ fontSize: "0.78rem", color: "var(--text-subtle)" }}>
            © {new Date().getFullYear()} LuxeMarket by Richzion. All rights
            reserved.
          </p>
